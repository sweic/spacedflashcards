...
import { CreateAdditionalOptions, CreateContainer, TextEditorsContainer } from "./Styles"
...
function Create({details}: {details?: DeckType}) {
  ...
  return (
    <>
    <AppHeader appProps={{headerName: details ? "Edit" : "Create", displayBack: true}}/>
    <CreateContainer>
        {curr !== -1 && <>
        <TextEditorsContainer>
            ...
            <TextEditor isFront={true} text={front} debounceFunction={setFront} />
            <TextEditor isFront={false} text={back} debounceFunction={setBack}/>
        </TextEditorsContainer>
